...
// Runecrafting plafonne au vrai niveau 25 (leveling_caps.runecrafting dans NEU-REPO
// leveling.json) -- ce tableau avait un index faux (15200 au lieu de 15300, niveau 24)
// ET 15 niveaux entièrement inventés au-delà du vrai cap (26 à 40, jamais dans NEU-REPO),
// trouvé en comparant ligne à ligne contre le fichier réel le 3 août. Sans impact constaté
// sur les données déjà en prod (les 2 seuls profils de test réels ont un XP runecrafting
// bien en dessous du point de divergence, niveau 3 max) -- corrigé avant qu'un vrai joueur
// à haut niveau ne soit affecté.
export const RUNECRAFTING_XP = [50,100,125,160,200,250,315,400,500,625,785,1000,1250,1600,2000,2465,3125,4000,5000,6200,7800,9800,12200,15300,19050]
