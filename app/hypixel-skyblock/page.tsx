...
export default function HypixelSkyblockHome() {
        ...
        <div style={{ display: 'grid', gap: '2.5rem' }}>
          {[
            ...
            },
            {
              ...
              desc: 'Seven net worth tiers, Starter through Master, each with Active Grind (the best verified skill-based methods for that tier, each with a real gear setup) and Vault Exclusive (non-obvious method innovations discovered by AI, Elite only).',
            },
            {
