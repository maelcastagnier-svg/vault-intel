...
// searches it for essence-shop related fields, same method as boss-kills /
// bank-fasttravel (never trust a remembered field path). Zero Claude cost --
...
export async function GET() {
  ...
  // recursive scan (co-op profile contains every teammate's data too, see
  // bank/fast-travel investigation for why that's misleading).
