// TEMP debug route -- calls extractEssence() directly against Cucumber's
...
import { extractEssence } from '../../player/sync/route'
...
export async function GET() {
  ...
  const { error: updateError } = await supabase
    .from('player_data')
    .update({ essence, updated_at: new Date().toISOString() })
