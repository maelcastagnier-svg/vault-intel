...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    garden_keys_found:  findKeysContaining(profile, 'garden'),
    accessory_keys_found: findKeysContaining(member, 'accessor').concat(findKeysContaining(member, 'bag_')).concat(findKeysContaining(member, 'tuning')),
