...
// already-synced player_data (no Hypixel call needed, no runEvolveSkills chain -- pure
// reads of tables already populated). Zero Claude cost. Deleted after use.
...
const WATCH_LABELS = new Set(['Unlock Fast Travel Zones', 'Crimson Essence Shop'])
