...
// Route de debug temporaire (Phase 5 -- verification Sharpness compose dans
// le DPS Zombie Slayer). Supprimee apres validation, meme pattern que toute
// route de debug du projet.
