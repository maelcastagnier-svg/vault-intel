// Route de debug TEMPORAIRE (Pluton architecture v2, 17 aout) -- classification
// element_type + gating du residu wiki_haiku_extract (~5207 pages, entries[] deja
// structurees par B2 -- source_label/stat_name_guess/bonus_raw/condition_note).
// Meme principe que trigger-elements-classify-wte (jugement Haiku par PAGE, applique
// a toutes ses entries residuelles) mais moins cher : les entries sont deja
// structurees, pas besoin de relire le contenu brut de la page.
