// TEMP debug route -- calls extractBankAndFastTravel() directly against
// Cucumber's real freshly-fetched member object, and writes the result
...
import { extractBankAndFastTravel } from '../../player/sync/route'
...
export async function GET() {
  ...
  return NextResponse.json({
    extracted: { bank_tier: bankFastTravel.bank_tier, fast_travel_zones_count: bankFastTravel.fast_travel_zones.length, fast_travel_zones_sample: bankFastTravel.fast_travel_zones.slice(0, 10) },
