...
### ✅ Source 2 (wiki officiel) — Combat/Slayer, 1er système exhaustivement couvert (1er août)

Reprise de la Source 2 après le chantier de masquage de contamination. Méthode : API
MediaWiki en direct (`action=query&list=allcategories`/`categorymembers`,
